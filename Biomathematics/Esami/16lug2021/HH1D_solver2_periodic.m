function [V_vec, m_vec, h_vec, n_vec, X, T]=HH1D_solver2_periodic(f,I,IT,h,delta_t,v_x0,v_x1,V0,m0,h0,n0,sigma,C_m,alpha_m,beta_m,alpha_h,beta_h,alpha_n,beta_n)
...
for k=2:length(T)
    ...
    F=(C_m*I/delta_t)*V_old + f(V_old, m_old, h_old, n_old, X, T(k-1)) + Iapp(X, T(k-1)); % Ocio all'X messo per i pti b e c in cui G_na e G_k sono funzioni di x
